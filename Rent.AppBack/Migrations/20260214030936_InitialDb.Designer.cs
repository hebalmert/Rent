...
namespace Rent.AppBack.Migrations
{
    ...
    [Migration("20260214030936_InitialDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rent.Domain.EntitesSoftSec.Usuario", b =>
                {
            ...
            modelBuilder.Entity("Rent.Domain.EntitesSoftSec.UsuarioRole", b =>
                {
            ...
            modelBuilder.Entity("Rent.Domain.Entities.City", b =>
                {
            ...
            modelBuilder.Entity("Rent.Domain.Entities.Corporation", b =>
                {
                    b.Property<int>("CorporationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rent.Domain.Entities.Country", b =>
                {
                    b.Property<int>("CountryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rent.Domain.Entities.Manager", b =>
                {
            ...
            modelBuilder.Entity("Rent.Domain.Entities.SoftPlan", b =>
                {
                    b.Property<int>("SoftPlanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rent.Domain.Entities.State", b =>
                {
                    b.Property<int>("StateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rent.Domain.Entities.UserRoleDetails", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Rent.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Rent.Domain.EntitesSoftSec.Usuario", b =>
                {
                    b.HasOne("Rent.Domain.Entities.Corporation", "Corporation")
                        .WithMany("Usuarios")
            ...
            modelBuilder.Entity("Rent.Domain.EntitesSoftSec.UsuarioRole", b =>
                {
                    ...
                    b.HasOne("Rent.Domain.EntitesSoftSec.Usuario", "Usuario")
                        .WithMany("UsuarioRoles")
            ...
            modelBuilder.Entity("Rent.Domain.Entities.City", b =>
                {
                    b.HasOne("Rent.Domain.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Rent.Domain.Entities.Corporation", b =>
                {
                    b.HasOne("Rent.Domain.Entities.Country", "Country")
                        .WithMany("Corporations")
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Rent.Domain.Entities.SoftPlan", "SoftPlan")
                        .WithMany("Corporations")

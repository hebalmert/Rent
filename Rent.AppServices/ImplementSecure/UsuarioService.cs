...
using Rent.AppInfra;
using Rent.AppInfra.EmailHelper;
using Rent.AppInfra.ErrorHandling;
using Rent.AppInfra.Extensions;
using Rent.AppInfra.FileHelper;
using Rent.AppInfra.Transactions;
...
namespace Rent.Services.ImplementSecure;
...
public class UsuarioService : IUsuarioService
{
    ...
    public UsuarioService(DataContext context, IHttpContextAccessor httpContextAccessor, HttpErrorHandler httpErrorHandle,
        ITransactionManager transactionManager, IFileStorage fileStorage, IStringLocalizer<Errors> localizer,
